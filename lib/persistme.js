...
var _lzString = __webpack_require__(4);
...
var Storage = function () {
    ...
    _createClass(Storage, [{
        ...
        value: function set(key, value) {
            ...
            try {
                ...
                if (typeof _val !== 'undefined') {
                    localStorage.setItem(itemKey, compress(_val));
                }
            } catch (ex) {
        ...
        value: function get(key) {
            ...
            if (!(0, _utils.isValid)(item)) {
                var _options$get2 = _options.get(this),
                    defaults = _options$get2.defaults;
        ...
        value: function update(key, value) {
            ...
            } else if ((typeof existingVal === 'undefined' ? 'undefined' : _typeof(existingVal)) === 'object' && (typeof val === 'undefined' ? 'undefined' : _typeof(val)) === 'object') {
                // is an object, extend original and set
                this.set(key, (0, _lodash2.default)(existingVal, value));
            } else {
